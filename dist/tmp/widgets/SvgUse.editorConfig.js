...
function getPreview(values, isDarkMode) {
  ...
  //     children: []
  // };
  var mySvgImage = "\n        <svg width=\"40\" height=\"40\">\n            <rect fill=\"".concat(isDarkMode ? "#465BE0" : "#0397ec", "\" width=\"40\" height=\"40\" rx=\"4\" ry=\"4\" />\n            <path fill=\"").concat(isDarkMode ? "#313131" : "#fff", "\" d=\"M2.92,24.88l1.96-2.36c.98,.74,2.14,1.26,3.32,1.26,1.04,0,1.44-.34,1.44-.76,0-.76-.68-.92-1.88-1.42l-1.62-.68c-1.5-.56-2.74-1.74-2.74-3.62,0-2.22,2-4.04,4.96-4.04,1.54,0,3.18,.56,4.44,1.74l-1.72,2.16c-.94-.62-1.68-.94-2.92-.94-.76,0-1.28,.28-1.28,.88s.74,.82,2.04,1.3l1.5,.62c1.74,.64,2.74,1.76,2.74,3.56,0,2.2-1.84,4.16-5.2,4.16-1.7,0-3.58-.6-5.04-1.86Z\"/>\n            <path fill=\"").concat(isDarkMode ? "#313131" : "#fff", "\" d=\"M14.12,13.5h3.64l1.36,5.68c.36,1.38,.6,2.72,.96,4.12h.08c.36-1.4,.62-2.74,.96-4.12l1.32-5.68h3.52l-3.84,13h-4.16l-3.84-13Z\"/>\n            <path fill=\"").concat(isDarkMode ? "#313131" : "#fff", "\" d=\"M26.84,20.1c0-4.4,2.74-6.84,6.12-6.84,1.76,0,3.02,.8,3.88,1.68l-1.88,2.12c-.54-.52-1.06-.84-2-.84-1.42,0-2.58,1.4-2.58,3.76s.9,3.8,2.76,3.8c.32,0,.68-.08,.88-.24v-1.8h-1.62v-2.8h4.68v6.2c-.88,.8-2.48,1.6-4.14,1.6-3.34,0-6.1-2.2-6.1-6.64Z\"/>\n        </svg>");
  return {
    type: "Container",
    borders: false,
    ...
    children: [{
      ...
      children: [{
        ...
        children: [{
          ...
          fontSize: 12,
          content: " ".concat(values.svgName)
        }, {
          type: "Text",
          fontColor: isDarkMode ? "#FFF" : "#000",
          fontSize: 8,
          content: " ".concat(values.svgSize, "px").concat(values.svgColorVar ? ',' : '', " ").concat(values.svgColorVar)
        }],
        grow: 1
      }]
    }]
